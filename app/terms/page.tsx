    ...
    return (
        <div className="min-h-screen bg-[#08080C] pt-20 pb-16">
            <div className="container max-w-3xl mx-auto px-4 md:px-6">
                <h1 className="text-4xl font-bold text-[#F2F0ED] mb-2">Terms of Service</h1>
                ...
                <div className="prose max-w-none space-y-8 text-[#8A8494] leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">1. Agreement to Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">2. Description of Service</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">3. Account Registration</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">4. Subscriptions and Payments</h2>
                        <h3 className="text-lg font-semibold text-[#F2F0ED] mt-4 mb-2">4.1 Free Tier</h3>
                        <p>
                        ...
                        <ul className="list-disc pl-6 space-y-1 mt-2">
                            ...
                            <li>All subscriptions include a {TRIAL_DAYS}-day free trial for new users. Nothing is charged until the trial ends, and cancelling during it costs nothing.</li>
                            <li>Payment is processed securely through Stripe. We do not store your payment card details.</li>
                            <li>Subscriptions automatically renew unless canceled before the renewal date.</li>
                        </ul>

                        <h3 className="text-lg font-semibold text-[#F2F0ED] mt-4 mb-2">4.3 Cancellation and Refunds</h3>
                        <ul className="list-disc pl-6 space-y-1 mt-2">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">5. Acceptable Use</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">6. Intellectual Property</h2>
                        <ul className="list-disc pl-6 space-y-2 mt-2">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">7. AI-Generated Content Disclaimer</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">8. Limitation of Liability</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">9. Disclaimer of Warranties</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">10. Termination</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">11. Changes to Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">12. Governing Law</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[#F2F0ED] mb-3">13. Contact Us</h2>
                        <p>
